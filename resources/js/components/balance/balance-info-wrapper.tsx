...
export const BalanceInfoWrapper: React.FC<BalanceInfoWrapperProps> = (props) => {
    return (
        <section className="mb-8 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            <BalanceInfo title="Total Saldo" value={props.totalAmount} description="dari 5 Saldo" />
            <BalanceInfo title="Saldo tertinggi" value={props.highestBalance} description="di antara 5 saldo" />
